...
<body>
    ...
    <div class="ui pushable segment">
        <div class="ui sidebar vertical menu">
            ...
            <a href="#company" class="borderless item active">Company</a>
            <a href="#products" class="borderless item">Products</a>
            <a href="#antennas" class="borderless item">Antennas</a>
        ...
        <div class="pusher">
            ...
            <div id="products" class="ui center aligned container">
                <h1 class="ui horizontal divider huge header header-title">
                    ...
                    <div class="sub header product-description">
            ...
            <div class="ui placeholder"></div>
                ...
                <div id="company">
                    ...
                    <h1 class="ui horizontal divider inverted header container header-title" style="margin-top: 8em!important;">
                    ...
                    <h1 class="ui horizontal divider header container header-title">
                        Technology
                    </h1>
                    <div class="sub header product-description">
